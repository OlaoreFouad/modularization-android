...
import dev.olaore.ui_herolist.ui.test.TAG_HERO_FILTER_UNKNOWN_CHECKBOX
...
fun PrimaryAttrFilterSelector(
    ...
    Column(
        ...
        Row(
            ...
            Text(
                text = stringResource(R.string.primaryAttribute),
                style = MaterialTheme.typography.h3,
            )
        }
...
fun PrimaryAttrSelector(
    ...
    Row(
        ...
        Text(
            text = HeroAttribute.Strength.value,
    ...
    Row(
        ...
        Text(
            text = HeroAttribute.Agility.value,
            style = MaterialTheme.typography.body1,
        )
    }
    ...
    Row(
        ...
        Text(
            text = HeroAttribute.Intelligence.value,
            style = MaterialTheme.typography.body1,
        )
    }
